...
- [x] **Tests integración — aislamiento tenant:** `clientes-`, `gastos-`, `empleados-`, `kits-`, `proveedores-`, `promociones-`, `cotizaciones-`, `tarjetas-regalo-`, `recetas-tenant-isolation.integration.test.ts` (404/403 según módulo); **2026-05-12:** `comprobantes-`, `tiendas-`, `cajas-`, `auditoria-tenant-isolation.integration.test.ts`; inventario en `docs/arquitectura/TENANT-ISOLATION-INVENTORY.md`.

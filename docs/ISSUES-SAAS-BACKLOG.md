...
- [x] **Aislamiento tenant — clientes y gastos:** `clientes-tenant-isolation.integration.test.ts` (GET ajeno → 404) y `gastos-tenant-isolation.integration.test.ts` (GET ajeno → 403); ver `docs/arquitectura/TENANT-ISOLATION-INVENTORY.md`.

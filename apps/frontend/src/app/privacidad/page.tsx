...
export default function PrivacidadPage() {
  return (
    <PublicPageShell backHref="/login" backLabel="Volver al inicio de sesión">
      <main aria-labelledby="privacidad-heading">
        <article className="card p-8 md:p-10">
          <h1 id="privacidad-heading" className="font-display text-2xl font-bold tracking-tight text-navy-800 mb-2">

...
import {
  ...
  Loader2, DollarSign, Package, Users, Download, FileText,
} from 'lucide-react';
...
type Tab = 'ventas' | 'pnl' | 'inventario' | 'clientes' | 'dgii';

const TABS: { id: Tab; label: string; icon: React.ReactNode }[] = [
  { id: 'ventas',     label: 'Ventas',      icon: <BarChart3  size={15} /> },
  { id: 'pnl',        label: 'P&L',         icon: <DollarSign size={15} /> },
  { id: 'inventario', label: 'Inventario',  icon: <Package    size={15} /> },
  { id: 'clientes',   label: 'Clientes',    icon: <Users      size={15} /> },
  { id: 'dgii',       label: 'DGII',        icon: <FileText   size={15} /> },
];
...
export default function ReportesPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader title="Reportes" breadcrumb={['Panel', 'Reportes']} />
